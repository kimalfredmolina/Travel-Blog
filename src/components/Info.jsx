  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="programs-section mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="card bg-white shadow-md rounded-lg p-4 relative">
            <img src="../assets/luz5.jpg" alt="Tvis1" className="rounded-lg"/>
            <div className="absolute bottom-4 left-4 text-white">
              <h3 className="text-xl font-semibold">Tanzania</h3>
            </div>
          </div>
          <div className="card bg-white shadow-md rounded-lg p-4 relative">
            <img src="../assets/luz6.jpg" alt="vis2" className="rounded-lg"/>
            <div className="absolute bottom-4 left-4 text-white">
              <h3 className="text-xl font-semibold">Vietnam</h3>
            </div>
          </div>
          <div className="card bg-white shadow-md rounded-lg p-4 relative">
            <img src="../assets/luz7.jpg" alt="vis3" className="rounded-lg"/>
            <div className="absolute bottom-4 left-4 text-white">
              <h3 className="text-xl font-semibold">Nepal</h3>
            </div>
          </div>
          <div className="card bg-white shadow-md rounded-lg p-4 relative">
            <img src="../assets/luz8.jpg" alt="vis4" className="rounded-lg"/>
            <div className="absolute bottom-4 left-4 text-white">
